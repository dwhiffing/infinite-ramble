        ...
        update: function update(game) {
          ...
          if (this.game.player.lasso.shooting) {
            game.physics.arcade.overlap(
              game.player.lasso,
              game.enemies.group,
              this._lassoCollide.bind(this)
            )
          }
          game.physics.arcade.overlap(
            game.player.sprite,
            game.enemies.group,
            this._dogCollide.bind(this)
          )
        },
          ...
          },
          {
            ...
            value: function spawn(row) {
              ...
              setTimeout(function() {
                ...
                var size = _this.game.rnd.integerInRange(
                  data.size[0],
                  data.size[1]
                )
        ...
        _createClass(Dog, [
          {
            ...
            value: function reset(x, y, type, row) {
              _get(
                Dog.prototype.__proto__ || Object.getPrototypeOf(Dog.prototype),
                'reset',
                this
              ).call(this, x, y)
              this.row = row
    ...
    /***/ function(module, exports) {
      ...
      var UserInterface = (function() {
        function UserInterface(game) {
          ...
          this.lifeText = game.add.bitmapText(
            2,
            1,
            'font',
            this.lives.toString(),
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      exports.default = {
        ...
        create: function create(game) {
          ...
          game.scoreText = game.add.bitmapText(
            20,
            38,
            'font',
            score.toString(),
        ...
        update: function update(game) {
          if (
            ...
            this.game.inputManager.isDown['reset']
          ) {
            this.game.state.start('play', true, false)
          }
        },
