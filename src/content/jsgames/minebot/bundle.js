  ...
  _createClass(Interface, {
    ...
    createShop: {
      value: function createShop() {
        ...
        game.upgrades = [{ text: "Get more armor", cost: 100, increase: 400, level: 0, max: 5 }, { text: "Lay mines faster", cost: 100, increase: 100, level: 0, max: 5 }, { text: "Lay more mines at once", cost: 300, increase: 200, level: 0, max: 5 }, { text: "Mines have a larger blast", cost: 500, increase: 500, level: 0, max: 3 }, { text: "Charge energy faster", cost: 500, increase: 500, level: 0, max: 3 }, { text: "Repair all damage", cost: 100 }, { text: "Release energy while stationary for a blast", cost: 1000 }, { text: "Gain a charging defensive shield [NOT YET IMPLEMENTED]", cost: 2000 }, { text: "Shoot two shots at once [NOT YET IMPLEMENTED]", cost: 3000 }, { text: "Shots bounce off walls [NOT YET IMPLEMENTED]", cost: 3000 }];
    ...
    updateForUpgrades: {
      value: function updateForUpgrades() {
        ...
        game.bot.max_mines = 2 + game.upgrades[2].level + 1;
...
var Rocket = (function (_Phaser$Sprite) {
  ...
  _createClass(Rocket, {
    ...
    reset: {
      value: function reset(x, y) {
        var speed = arguments[2] === undefined ? 300 : arguments[2];
