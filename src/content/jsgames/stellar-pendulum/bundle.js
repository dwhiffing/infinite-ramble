/******/ ;(function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      exports.default = {
        create: function create(game) {
          ...
          this.spawner = new _spawner2.default(
            game,
            ballCollisionGroup,
            playerCollisionGroup
          )
        ...
        update: function update(game) {
          ...
          if (this._shakeWorldTime > 0) {
            var magnitude =
              this._shakeWorldTime / this._shakeWorldMax * this._shakeWorldMax
        ...
        collide: function collide(player, ball) {
          ...
          var speed =
            Math.abs(velocity.x) +
            Math.abs(velocity.y) * this.player.ball.body.mass
          ...
          this.game.ui.hitTarget(
            sprite,
            finalSpeed,
            velocity,
            this.player.ball.body.mass
          )
          sprite.kill()
          this.spawner.spawn()
        },
    ...
    /***/ function(module, exports) {
      ...
      var Spawner = (function() {
        function Spawner(game, ballCollisionGroup, playerCollisionGroup) {
          ...
          nextPos = {
            x: this.game.rnd.integerInRange(100, this.game.world.width - 100),
            y: this.game.rnd.integerInRange(100, this.game.world.height - 100),
          }
          nextPos2 = {
            x: this.game.rnd.integerInRange(100, this.game.world.width - 100),
            y: this.game.rnd.integerInRange(100, this.game.world.height - 100),
          ...
          },
          {
            ...
            value: function spawn() {
              ...
              nextPos2 = {
                ...
                y: this.game.rnd.integerInRange(
                  100,
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var Player = (function() {
        function Player(
          ...
          this.distBar = new _amountBar2.default(
            game,
            game.world.centerX,
        ...
        _createClass(Player, [
          ...
          },
          {
            ...
            value: function adjustLine(size) {
              ...
              mouseSpring = this.game.physics.p2.createSpring(
                this.mouse,
                this.ball,
                lineSize / 10,
                60,
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var timer = 5
      var initialComboTime = 3000
      var timePerHit = 1000
      var particleLifetime = 5000
      ...
      var UserInterface = (function() {
        function UserInterface(game, time, onTimeUp) {
          ...
          this.comboBar = new _timerBar2.default(
            game,
            game.world.centerX,
          ...
          this.redEmitter = game.add.emitter(0, 0, 100)
          this.redEmitter.makeParticles('bit')
          this.redEmitter.setAlpha(0.9, 0, 4000)
          this.redEmitter.gravity = 400
          this.redEmitter.forEach(function(particle) {
            return (particle.tint = 0xff0000)
          })

          this.blueEmitter = game.add.emitter(0, 0, 100)
          this.blueEmitter.makeParticles('bit')
          this.blueEmitter.setAlpha(0.9, 0, 4000)
          this.blueEmitter.gravity = 400
          this.blueEmitter.forEach(function(particle) {
            return (particle.tint = 0x0000ff)
          })

          this.yellowEmitter = game.add.emitter(0, 0, 300)
          this.yellowEmitter.makeParticles('bit')
          this.yellowEmitter.setAlpha(0.9, 0, 4000)
          this.yellowEmitter.gravity = 400
          this.yellowEmitter.forEach(function(particle) {
            return (particle.tint = 0xffff00)
          })
        }
        ...
        _createClass(UserInterface, [
          ...
          },
          {
            ...
            value: function hitTarget(sprite, speed, velocity, mass) {
              ...
              this.emitter.setXSpeed(
                -200 + velocity.x * 0.2,
                200 + velocity.x * 0.3
              )
              this.emitter.setYSpeed(
                -200 + velocity.y * 0.2,
                200 + velocity.y * 0.3
              )
          ...
          },
          {
            ...
            value: function createScoreText(x, y, score) {
              ...
              var text = this.game.add.text(x, y, score, {
                font:
                  'bold ' +
                  Math.min(Math.ceil(14 + score * 0.02), 20) +
                  'px Arial',
                fill: '#fff',
              })
              setTimeout(function() {
